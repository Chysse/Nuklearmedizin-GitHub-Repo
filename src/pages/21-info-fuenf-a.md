...
nav: Infotext · Die 5 A des Strahlenschutzes
group: Modul I
order: 21
...
Ionisierende Strahlung lässt sich weder sehen noch spüren. Trotzdem kann man sich wirksam schützen – mit fünf einfachen Regeln, die im Strahlenschutz überall gelten, vom Zahnarzt bis zum Kernkraftwerk. Alle fünf beginnen mit A.

| Regel | Was dahintersteckt | Beispiel |
| --- | --- | --- |
...
## Zählrate und Nullrate – die Messgrößen dieses Moduls

Mit einem **Geiger-Müller-Zählrohr** zählt man Strahlungsteilchen: Jedes Teilchen, das ins Zählrohr gelangt, erzeugt einen elektrischen Impuls. Die **Zählrate** $R$ ist die Anzahl der Impulse $N$ pro Messzeit $\Delta t$:

$$R = \frac{N}{\Delta t}$$

Auch ohne Präparat zählt das Zählrohr etwas: die natürliche Umgebungsstrahlung aus Boden, Baustoffen und Weltall. Diese **Nullrate** $R_0$ misst man zuerst und zieht sie von allen weiteren Messungen ab:
